...
<html lang="en-us">
    ...
    <a href="#hard">hard/advanced</a><br>
    <a href="#sql">sql/begginning</a><br>
    <a href="#medium">sql/medium</a><br>
    <a href="#HARD">sql/hard</a>
    ...
    Also, more basic things are or, and, as, and that weird thing. (SELECT name AS catogary FROM me WHERE id>"1" or name="atle" and id&lt;54).<br>
Third,  the SUM, MIN, MAX, COUNT, AVG( SELECT *, SUM(id) AS cool_numbers FROM me GROUP by name), fourth is having instead of group by or order by.
    </h4>
    <h3 class="sql" id="medium">MEDIUM</h3>
    <h4 class="sql">The first medium item is</h4>
    <h3 class="sql" id="HARD">HARD</h3>
    <h4 class="sql">The first hard catagory one is case. I tried, but it always said syntax error so just look here</h4> <a href="https://www.khanacademy.org/computer-programming/or-go-to-httpswwwkhanacademyorgcomputingcomputer-programmingsqlmore-advanced-sql-queriesptcalculating-results-with-case/5047120965353472">sqlye</a>
    </body>
</html>
